...
<!-- drawer component -->
<div id="drawer-example" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-medium dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
