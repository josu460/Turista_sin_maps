...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <!-- Tarjeta Reporte Usuarios -->
        <a href="#" class="flex flex-col items-center bg-yellow-200 p-8 rounded-lg shadow-md hover:bg-yellow-300 transition">
            ...
            <h2 class="text-xl font-semibold">Reportes Usuarios</h2>
            <div class="flex space-x-4 mt-4">
                <a href="#" class="text-white bg-green-500 hover:bg-green-600 font-medium rounded-lg text-sm px-5 py-2.5">Excel</a>
                <a href="#" class="text-white bg-red-500 hover:bg-red-600 font-medium rounded-lg text-sm px-4 py-2">PDF</a>
            </div>
        </a>

        <!-- Tarjeta Reporte Aviones -->
        <a href="#" class="flex flex-col items-center bg-blue-200 p-8 rounded-lg shadow-md hover:bg-blue-300 transition">
        ...
        <a href="#" class="flex flex-col items-center bg-green-200 p-8 rounded-lg shadow-md hover:bg-green-300 transition">
